...
/*
 * RMS-34 is my layout based _heavily_ on Miryoku, but I wanted to make some
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE_Q] = LAYOUT_rms34(
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                      XXXXXXX, SPC_NAV, TAB_MED, ENT_SYM, BSP_NUM, XXXXXXX
  ),
  [_BASE_C] = LAYOUT_rms34(
  ...
  [_NUM] = LAYOUT_rms34(
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT,  KC_SLSH,
                      XXXXXXX, KC_0,    KC_MINS, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  [_SYM] = LAYOUT_rms34(
    ...
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                      XXXXXXX, KC_RPRN, KC_UNDS, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  [_FUN] = LAYOUT_rms34(
...
bool process_record_rms34(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    case QWERTY:
 ...
 * Achordion config
 */
uint16_t achordion_timeout_rms34(uint16_t tap_hold_keycode) {
